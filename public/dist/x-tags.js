...
xtag.register("x-code-prism", {
    ...
    accessors: {
        codeContent: {
            set: function(code) {
                this.innerHTML = '<pre><code class="language-' + (this.getAttribute("language") || "javascript") + '">' + code + "</code></pre>";
...
!function(t, e, i) {
    var n = t.L, o = {};
    o.version = "0.7-dev", "object" == typeof module && "object" == typeof module.exports ? module.exports = o : "function" == typeof define && define.amd && define(o), 
    o.noConflict = function() {
        ...
        compileTemplate: function(t, e) {
            return t = t.replace(/\{ *([\w_]+) *\}/g, function(t, i) {
    ...
    o.Mixin = {}, o.Mixin.Events = {
        ...
        removeEventListener: function(t, e, i) {
            ...
            var n, a, r, h, l, u, c, d, p, m = this[s], _ = i && o.stamp(i);
    ...
    function() {
        ...
        invalidateSize: function(t) {
            ...
            var e = this.getSize();
            if (this._sizeChanged = !0, this._initialCenter = null, this.options.maxBounds && this.setMaxBounds(this.options.maxBounds), 
        ...
        unproject: function(t) {
            for (var e, i = o.LatLng.RAD_TO_DEG, n = this.R_MAJOR, s = this.R_MINOR, a = t.x * i / n, r = s / n, h = Math.sqrt(1 - r * r), l = Math.exp(-t.y / n), u = Math.PI / 2 - 2 * Math.atan(l), c = 15, d = 1e-7, p = c, m = .1; Math.abs(m) > d && --p > 0; ) e = h * Math.sin(u), 
            m = Math.PI / 2 - 2 * Math.atan(l * Math.pow((1 - e) / (1 + e), .5 * h)) - u, u += m;
        ...
        getTileUrl: function(t) {
            var e = this._map, i = this.options.tileSize, n = t.multiplyBy(i), s = n.add([ i, i ]), a = this._crs.project(e.unproject(n, t.z)), r = this._crs.project(e.unproject(s, t.z)), h = [ a.x, r.y, r.x, a.y ].join(","), l = o.Util.template(this._url, {
                s: this._getSubdomain(t)
            });
        ...
        bindPopup: function(t, e) {
            ...
            this._popupHandlersAdded = !0), t instanceof o.Popup ? (o.setOptions(t, e), this._popup = t) : this._popup = new o.Popup(e, this).setContent(t), 
            this;
        },
    ...
    o.Marker.include(a), o.Circle.include(a), o.CircleMarker.include(a), o.Polyline.include({
        ...
        getMousePosition: function(t, i) {
            var n = o.Browser.ie7, s = e.body, a = e.documentElement, r = t.pageX ? t.pageX - s.scrollLeft - a.scrollLeft : t.clientX, h = t.pageY ? t.pageY - s.scrollTop - a.scrollTop : t.clientY, l = new o.Point(r, h);
            if (!i) return l;
            var u = i.getBoundingClientRect(), c = u.left - i.clientLeft, d = u.top - i.clientTop;
    ...
    o.Draggable = o.Class.extend({
        ...
        _onDown: function(t) {
            ...
            !o.Draggable._disabled)) {
                ...
                o.Browser.touch && n.tagName && "a" === n.tagName.toLowerCase() && o.DomUtil.addClass(n, "leaflet-active"), 
                this._moving || (this._startPoint = new o.Point(i.clientX, i.clientY), this._startPos = this._newPos = o.DomUtil.getPosition(this._element), 
        ...
        addDoubleTapListener: function(t, i, n) {
            function s(t) {
                var e;
                if (o.Browser.msTouch ? (m.push(t.pointerId), e = m.length) : e = t.touches.length, 
                !(e > 1)) {
            ...
            var r, h, l = !1, u = 250, c = "_leaflet_", d = this._touchstart, p = this._touchend, m = [];
            t[c + d + n] = s, t[c + p + n] = a;
            var _ = o.Browser.msTouch ? e.documentElement : t;
            return t.addEventListener(d, s, !1), _.addEventListener(p, a, !1), o.Browser.msTouch && _.addEventListener("MSPointerCancel", a, !1), 
            this;
        },
        ...
        addMsTouchListenerStart: function(t, i, n, s) {
            var a = "_leaflet_", r = this._msTouches, h = function(t) {
            ...
            if (t[a + "touchstart" + s] = h, t.addEventListener("MSPointerDown", h, !1), !this._msDocumentListener) {
                var l = function(t) {
                ...
                e.documentElement.addEventListener("MSPointerUp", l, !1), e.documentElement.addEventListener("MSPointerCancel", l, !1), 
    ...
    o.Map.mergeOptions({
        ...
        setView: function(t, e, n) {
            if (e = e === i ? this._zoom : this._limitZoom(e), t = o.latLng(t), n = n || {}, 
...
(function() {
    var setLocation = function(element) {
        if (element.location == "auto") {
            element.xtag.map.locate({
                setView: true,
                maxZoom: element.zoom
            });
        } else {
    ...
    var setTileLayer = function() {
        ...
        this.xtag.tilelayer = new L.TileLayer("http://{s}.tile.cloudmade.com/" + this.getAttribute("key") + "/" + (this.getAttribute("tile-set") || 997) + "/256/{z}/{x}/{y}.png", this.getAttribute("tile-options") || {});
    ...
    xtag.register("x-map", {
        lifecycle: {
            created: function() {
                ...
                [ "load", "viewreset", "movestart", "move", "moveend", "dragstart", "zoomend", "layeradd", "layerremove", "locationfound", "drag", "dragend", "locationerror", "popupopen", "popupclose" ].forEach(function(type) {
                    ...
                    xtag.toArray(container.children).forEach(function(child) {
                        if (child.nodeName == "SCRIPT") {
                            ...
                            if (child.src.length > 0) {
                                ...
                                script.appendChild(document.createTextNode(child.text || child.textContent || child.innerHTML));
                            }
